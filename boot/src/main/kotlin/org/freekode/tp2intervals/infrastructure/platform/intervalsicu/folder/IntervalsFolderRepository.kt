...
class IntervalsFolderRepository(
    ...
    private fun createFolder(name: String, startDate: LocalDate?, type: String): _root_ide_package_.org.freekode.tp2intervals.infrastructure.platform.intervalsicu.folder.FolderDTO {
